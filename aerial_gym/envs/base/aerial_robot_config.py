...
class AerialRobotCfg(BaseConfig):
    ...
    class control:
        ...
        scale_input = [
            ...
            1.0,
            1.0,
        ]  # scale the input to the controller from -1 to 1 for each dimension, scale from -np.pi to np.pi for yaw in the case of position control
    ...
    class sim:
        ...
        class physx:
            ...
            contact_collection = (
                0  # 0: never, 1: last sub-step, 2: all sub-steps (default=2)
            )
